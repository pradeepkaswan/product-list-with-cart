        ...
        {state.items.length > 0 ? (
          <div className="flex flex-col gap-6">
              ...
              <div key={item.name} className="flex items-center justify-between">
                <div>
                  ...
                  <p className="font-semibold">
                    <span className="text-red mr-4">{item.quantity}x</span>
                    <span className="text-rose-400 mr-2">@${item.price}</span>
                    <span className="text-rose-500">${item.quantity * item.price}</span>
                  </p>
                </div>
                <button
                  className="border rounded-full p-0.5 text-rose-300"
            ...
            <p className="flex items-center justify-between">
              Order Total <span className="font-bold text-heading-md">${total.toFixed(2)}</span>
            </p>
            <div className="flex items-center justify-center text-body-sm gap-2 py-2 rounded-xl bg-rose-100">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="21"
                height="20"
            ...
            <button
              className="w-full bg-red text-rose-50 rounded-full py-3 text-sm"
              onClick={() => {
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="text-rose-500 text-body-sm font-semibold">
